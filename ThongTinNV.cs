...
namespace Nhom_1_BaiThiCuoiKy
{
    public partial class ThongTinNV : Form
    {
        ...
        {
            txtTenNV.Focus();
            lvTTNV.Columns[0].Width = (int)(lvTTNV.Width * 0.2);
            lvTTNV.Columns[1].Width = (int)(lvTTNV.Width * 0.25);
            ...
            ListViewItem item = lvTTNV.Items.Add("172100168");
            item.SubItems.Add("Nguyễn Minh Trung");
            ...
            } else
            {
                for (int i = 0; i < lvTTNV.Items.Count; i++)
                {
                    if (txtMaNV.Text == lvTTNV.Items[i].Text)
                    {
                        ...
                        return;
                    } else if (txtSDT.Text == lvTTNV.FindItemWithText(txtSDT.Text))
                    {
                        
                        MessageBox.Show("Không được trùng số điện thoại!", "Thông báo!", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                        txtSDT.Clear();
                        txtSDT.Enabled = true;
                        return;
                    }
                }
                ListViewItem item = lvTTNV.Items.Add(txtMaNV.Text);
        ...
        private void lvTTNV_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtMaNV.Text = lvTTNV.SelectedItems[0].SubItems[0].Text;
                txtTenNV.Text = lvTTNV.SelectedItems[0].SubItems[1].Text;
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (lvTTNV.SelectedItems.Count > 0)
            {
                lvTTNV.SelectedItems[0].SubItems[0].Text = txtMaNV.Text;
                lvTTNV.SelectedItems[0].SubItems[1].Text = txtTenNV.Text;
        ...
        private void txtSDT_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                DialogResult dl;
                dl = MessageBox.Show("Bạn không được nhập chữ!!!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                e.Handled = true;
            }
        }
        ...
        private void txtTenNV_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                DialogResult hoiso;
                hoiso = MessageBox.Show("Không được nhập số!!", "Thông báo!", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1);
                e.Handled = true;
            }
        }
    }
